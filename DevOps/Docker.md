...
* **For a typical Class C subnet like 192.168.0.0/24: Network address: 192.168.0.0 Usable host addresses: 192.168.0.1 to 192.168.0.254 Broadcast address: 192.168.0.255 The router or default gateway is often assigned the first usable address (e.g., 192.168.0.1), while other devices receive addresses from the remaining range, typically via DHCP**
