...
set output 'translational-KE.pdf'
...
c=1
plot "twater/KEtransfer.dat" using ($1*0.001):(avg_n($3*c+0.0006+0.0008)) title       "H_2O (ref.)" with line ls 1 lc rgb "black" lw 0.2 dt 1,\
     ...
     "tmgcl2-1mol/KEtransfer.dat" using ($1*0.001):(avg_n($3*c+0.0006+0.0008)) title       "MgCl_2 (1M)" with line ls 1 lc rgb "blue" lw 0.2 dt 1,\
     'tmgcl2-1mol/KEtransfer.dat' using ($1*0.001):((avg_n($3*c+0.0006+0.0008+0.0004))):((avg_n($3*c+0.0006+0.0008-0.0004))) with filledcurves lc "blue" notitle,\
     "tmgcl2-2mol/KEtransfer.dat" using ($1*0.001):(avg_n($3*c+0.0006+0.0008)) title       "MgCl_2 (2M)" with line ls 1 lc rgb "dark-green" lw 0.2 dt 1,\
     'tmgcl2-2mol/KEtransfer.dat' using ($1*0.001):((avg_n($3*c+0.0006+0.0008+0.0004))):((avg_n($3*c+0.0006+0.0008-0.0004))) with filledcurves lc "dark-green" notitle,\
     ...
     "tnaf/KEtransfer.dat" using ($1*0.001):(avg_n($3*c+0.0006+0.0008)) title       "NaF (1M)" with line ls 1 lc rgb "yellow" lw 0.2 dt 1,\
     'tnaf/KEtransfer.dat' using ($1*0.001):((avg_n($3*c+0.0006+0.0008+0.0004))):((avg_n($3*c+0.0006+0.0008-0.0004))) with filledcurves lc "yellow" notitle,\
