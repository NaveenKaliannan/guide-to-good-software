...
set key
c=0.4
plot "../experiment/H2O.dat" using ($1+1.15):($2*c) title       "Pure liquid water" with line ls 1 lc rgb "black" lw 2 dt 0,\
...
set key
c=0.0001
plot "purewater" using ($1*0.33-0.2):($2*c) title  "Pure liquid water" with line ls 1 lc rgb "black" lw 2 dt 0,\
