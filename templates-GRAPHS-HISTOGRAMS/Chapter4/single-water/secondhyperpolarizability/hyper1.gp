...
set label "{/Symbol g}_{xxxx}" at 0.5,500  font 'Arial,20' textcolor rgb "black"
set xrange [0:2]
set yrange [-200:700]
set xlabel "t (ps)"
...
set label "{/Symbol g}_{yyyy}" at 0.5,500  font 'Arial,20' textcolor rgb "black"
set xrange [0:2]
set xlabel "t (ps)"
...
set label "{/Symbol g}_{zzzz}" at 0.5,500 font 'Arial,20' textcolor rgb "black"
set xrange [0:2]
set xlabel "t (ps)"
