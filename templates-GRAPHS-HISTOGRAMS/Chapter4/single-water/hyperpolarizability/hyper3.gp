...
set label "{/Symbol b}_{yyz}" at 0.5,30  font 'Arial,20' textcolor rgb "black"
set xrange [0:2]
set yrange [-40:40]
set xlabel "t (ps)"
...
set label "{/Symbol b}_{zzx}" at 0.5,30  font 'Arial,20' textcolor rgb "black"
set xrange [0:2]
set xlabel "t (ps)"
...
set label "{/Symbol b}_{zzy}" at 0.5,30 font 'Arial,20' textcolor rgb "black"
set xrange [0:2]
set xlabel "t (ps)"
