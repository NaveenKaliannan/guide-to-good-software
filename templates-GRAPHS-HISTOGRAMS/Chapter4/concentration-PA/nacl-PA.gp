...
plot path_to_directory1."/pureliquidwater/EDIDsecond.dat" using ($1*0.001):($2*c - 0) title       "Pure liquid water" with line ls 1 lc rgb "black" lw 0.2 dt 1,\
     ...
     path_to_directory1."/nacl-2mol/EDIDsecond.dat" using ($1*0.001):($2*c -  0  ) title "MgCl_2 (2 mol/L)"   with line ls 1 lc rgb "blue" lw 0.5,\
     path_to_directory1."/nacl-2mol/EDIDsecond.dat" using ($1*0.001):($2*c + 0.00012):($2*c - 0.00012) with filledcurves lc "blue" notitle,\
     path_to_directory1."/nacl-4mol/EDIDsecond.dat" using ($1*0.001):($2*c - 0 ) title   "MgCl_2 (4 mol/L)"   with line ls 1 lc rgb "red" lw 0.2,\
