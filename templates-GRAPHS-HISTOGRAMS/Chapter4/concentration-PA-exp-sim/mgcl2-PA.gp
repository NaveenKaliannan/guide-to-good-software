...
c=0.4
plot "../experiment/H2O.dat" using ($1+1.15):($2*c) title       "Pure liquid water" with line ls 1 lc rgb "black" lw 1.5 dt 7,\
     "../experiment/MgCl2_1M.dat" using ($1+1.15):($2*c) title    "MgCl_2 (1 mol/L)" with line ls 1 lc rgb "green" lw 1.5,\
     "../experiment/MgCl2_2M.dat" using ($1+1.15):($2*c) title    "MgCl_2 (2 mol/L)" with line ls 1 lc rgb "blue" lw 1.5,\
     "../experiment/MgCl2_4M.dat" using ($1+1.15):($2*c) title "MgCl_2 (4 mol/L)"   with line ls 1 lc rgb "red" lw 1.5,\
...
plot path_to_directory1."/pureliquidwater/EDIDsecond.dat" using ($1*0.001):($2*c - 0) title       "Pure liquid water" with line ls 1 lc rgb "black" lw 0.2 dt 1,\
     ...
     path_to_directory1."/mgcl2-1mol/EDIDsecond.dat" using ($1*0.001):($2*c - 0) title    "MgCl_2 (1 mol/L)" with line ls 1 lc rgb "green" lw 0.5,\
     path_to_directory1."/mgcl2-1mol/EDIDsecond.dat" using ($1*0.001):($2*c + 0.00012):($2*c - 0.00012) with filledcurves lc "green" notitle,\
     path_to_directory1."/mgcl2-2mol/EDIDsecond.dat" using ($1*0.001):($2*c -  0  ) title "MgCl_2 (2 mol/L)"   with line ls 1 lc rgb "blue" lw 0.5,\
     path_to_directory1."/mgcl2-2mol/EDIDsecond.dat" using ($1*0.001):($2*c + 0.00012):($2*c - 0.00012) with filledcurves lc "blue" notitle,\
     path_to_directory1."/mgcl2-4mol/EDIDsecond.dat" using ($1*0.001):($2*c - 0 ) title   "MgCl_2 (4 mol/L)"   with line ls 1 lc rgb "red" lw 0.2,\
