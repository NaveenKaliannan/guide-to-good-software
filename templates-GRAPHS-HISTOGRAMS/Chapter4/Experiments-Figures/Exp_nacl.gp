...
set output 'TKE_experiment_nacl.eps'
...
plot "../experiment/H2O.dat" using ($1+1.15):($2*c) title       "Pure liquid water" with line ls 1 lc rgb "black" lw 2 dt 7,\
     "../experiment/Fig2_Fig3_NaCl.txt" using ($1+1.15):($2*c) title    "NaCl (2 mol/L)" with line ls 1 lc rgb "blue" lw 2,\
     "../experiment/Fig2_Fig3_NaCl.txt" using ($3+1.15):($4*c) title "NaCl (4 mol/L)"   with line ls 1 lc rgb "red" lw 2,\
