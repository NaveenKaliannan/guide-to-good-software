...
set output 'intermolecular-coupling-locaframe.eps'

file1="../data/FFMD/0/inter_coupling_locframe.dat"
file2="../data/FFMD/10/inter_coupling_locframe.dat"
file3="../data/FFMD/100/inter_coupling_locframe.dat"
labelcolor="blue"
