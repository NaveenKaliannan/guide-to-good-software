...
set output 'intramolecular-coupling-molframe.eps'
...
set arrow 1 from 0.026, -0.48    to 0.026, -0.40   fill lc rgb "orange" 
...
set arrow 1 from 0.047, 0.20  to 0.047, 0.12  fill lc rgb "orange" 
...
plot file1 using ($1*0.001):($12) title  "Field-free (ref)" with line ls 1 lc rgb "black" lw 0.4 dt 0,\
     ...
     file3 using ($1*0.001):($12) title  "Strong THz pulse" with line ls 1 lc rgb "green" lw 0.4 dt 1,\
