...
set output 'intramolecular-coupling-molframe_auto.eps'

file1="../data/FFMD/0/intra_coupling_molframe.dat"
file2="../data/FFMD/10/intra_coupling_molframe.dat"
file3="../data/FFMD/100/intra_coupling_molframe.dat"
labelcolor="blue"
