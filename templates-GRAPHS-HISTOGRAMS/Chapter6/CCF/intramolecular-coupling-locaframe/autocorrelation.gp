...
set output 'intramolecular-coupling-locframe_auto.eps'

file1="../data/FFMD/0/intra_coupling_locframe.dat"
file2="../data/FFMD/10/intra_coupling_locframe.dat"
file3="../data/FFMD/100/intra_coupling_locframe.dat"
labelcolor="blue"
